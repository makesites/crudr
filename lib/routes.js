...
Routes.prototype = {
	...
	crud: function(){
		...
		Object.keys(routes).forEach(function(route) {
			// Collections
			server[route]( self.options.path + '/:domain', function reRoute(req, res) {
			...
			// Models
			server[route]( self.options.path + '/:domain/:id', function reRoute(req, res) {
	...
	static : function(){
		...
		server.get( this.options.static["client.js"], function(req, res){
