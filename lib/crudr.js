...
function setupRoutes( server ){
	...
	console.log( config.routes.create + '/:domain/:id' );
	
	// add crud events... 
	server.get( config.routes.create + '/:domain/:id', function(req, res) {
		// create record
		sync.handle(db[ req.params.domain ], req, function(err, result) {
			res.send('create, domain: ' + req.params.domain + ' id: ' + req.params.id);
		});
	  
	});
	server.get( config.routes.read + '/:domain/:id', function(req, res) {
	  // read record
	  res.send('read, domain: ' + req.params.domain + ' id: ' + req.params.id);
	});
	server.get( config.routes.update + '/:domain/:id', function(req, res) {
	  // update record
	  res.send('update, domain: ' + req.params.domain + ' id: ' + req.params.id);
	});
	server.get( config.routes.delete + '/:domain/:id', function(req, res) {
	  // delete record
	  res.send('delete, domain: ' + req.params.domain + ' id: ' + req.params.id);
	});
